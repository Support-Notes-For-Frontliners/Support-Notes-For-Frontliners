    ...
    <animated.div style={springProps}>
      <div>
        <PageTitleLayout backgroundClassName={classes.background}>
          ...
          >
        Notes For Frontliners is a student-run note submission portal that
            allows anyone in the community to write messages of inspiration to support 
            the mental health of our frontline workers. Our project 
             was founded in response to the emotional distress that
            continues to affect the mental health of America's frontline and essential workers, 
            including those working in hospitals, nursing homes, and homeless shelters.
